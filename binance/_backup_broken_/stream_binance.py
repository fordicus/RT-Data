...
try:
	(
		SYMBOLS, WS_URL, LOB_DIR, PURGE_ON_DATE_CHANGE,
...
def init_event_flags():
	...
	try:
		...
		global EVENT_1ST_SNAPSHOT, EVENT_LATENCY_VALID
		global EVENT_STREAM_ENABLE, EVENT_FLAGS_INITIALIZED
